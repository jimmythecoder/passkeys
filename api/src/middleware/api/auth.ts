...
export const api: FastifyPluginCallback = (fastify, _, next) => {
    ...
    fastify.post<{ Body: FromSchema<typeof schema.request.signin.getCredentails> }>(
        "/signin",
        { schema: { body: schema.request.signin.getCredentails } },
        async (request, reply) => {
            try {
    ...
    fastify.post<{ Body: FromSchema<typeof schema.request.signin.passkey> }>(
        "/signin/passkey",
        { schema: { body: schema.request.signin.passkey } },
        async (request, reply) => {
            try {
    ...
    fastify.post<{ Body: FromSchema<typeof schema.request.signin.verify> }>(
        "/signin/verify",
        { schema: { body: schema.request.signin.verify } },
        async (request, reply) => {
            try {
    ...
    fastify.post<{ Body: FromSchema<typeof schema.request.register.request> }>(
        "/register",
        { schema: { body: schema.request.register.request } },
        async (request, reply) => {
            try {
    ...
    fastify.post<{ Body: FromSchema<typeof schema.request.register.verify> }>(
        "/register/verify",
        { schema: { body: schema.request.register.verify } },
        async (request, reply) => {
            try {
